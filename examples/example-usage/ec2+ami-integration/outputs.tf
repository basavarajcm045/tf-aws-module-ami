...
output "ami_owner_id" {
  ...
  value       = module.ami.ami_owner_id
}

output "ami_description" {
  description = "Selected AMI description"
  value       = module.ami.ami_description
}
