...
data "aws_ami" "rhel" {
  ...
  filter {
    name   = "name"
    values = var.ami_name_filter != null ? [var.ami_name_filter] : ["RHEL-8*_HVM-*-${var.architecture}-*"]
  }
...
data "aws_ami" "rhel_9" {
  ...
  filter {
    name   = "name"
    values = var.ami_name_filter != null ? [var.ami_name_filter] : ["RHEL-9*_HVM-*-${var.architecture}-*"]
  }
